...
class TourScreen3Controller: UIViewController {
    ...
    func makeLayout() {
        ...
        // All Anime text
        var title = UILabel(frame: CGRectMake((screenWidth/2)-(99), (screenHeight/2)-30.5, 198, 61))
        title.text = "Watched";
        ...
        // Description text
        var blurb = UILabel(frame: CGRectMake((screenWidth/2)-150, title.frame.origin.y+61, 300, 99))
        ...
        // Image
        var mainImage: UIImage = UIImage(named: "History_Icon.png")!;
        var mainImageView = UIImageView(frame: CGRectMake((screenWidth/2)-mainImage.size.width/2, title.frame.origin.y-((mainImage.size.height)+40), mainImage.size.width, mainImage.size.height));
        mainImageView.image = mainImage;
        self.view.addSubview(mainImageView);
        
        // Pagination
        var pagination = UIImage(named: "Pagination3.png");
        ...
        // Done Button
        var doneButton = UIButton(frame: CGRectMake(screenWidth-88, 25, 61, 33));
